...
//   1. Locally computed config (i.e. configuration added or changed dynamically)
...
nconf.argv()
    ...
    // underscore replaces : as a way to denote hierarchy
    // (can use something like  ['PORT', 'NODE_ENV', 'FORCE_DB_SYNC', 'USE_HTTPS', 'forceSequelizeSync'] to select)
    .defaults({
        store: {
...
module.exports.getJavaScriptAssets = function (includeTests) {
    var output = this.getGlobbedFiles(this.assets.lib.js.concat(this.assets.js), 'static/');
...
module.exports.getCSSAssets = function () {
    var output = this.getGlobbedFiles(this.assets.lib.css.concat(this.assets.css), 'static/');
    return output;
};
